    ...
    <div class ="pull-left" style="width:20%;">
        ...
        <div class ="center-block" style="width: 70%;">
            ...
            <div id ="pull-left" style="width: 70%; float: left; line-height: 160%">
                <asp:TextBox ID="txtFName" class="text-left" runat="server">Test2Zip</asp:TextBox>
                ...
                <br />
                <asp:TextBox ID="txtLName" class="text-left" runat="server">Test2Zip</asp:TextBox>
                ...
                <br />
                <asp:TextBox ID="txtPassword" runat="server">Test2Zip</asp:TextBox>
                ...
                <br />
                <asp:TextBox ID="txtEmail" runat="server">a@aol.com</asp:TextBox>
